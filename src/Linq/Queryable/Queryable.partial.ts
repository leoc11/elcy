...
Queryable.prototype.innerJoin = function <T, T2, TKey, TResult>(this: Queryable<T>, array2: Queryable<T2>, keySelector1: (item: T) => TKey, keySelector2: (item: T2) => TKey, resultSelector?: (item1: T, item2: T2) => TResult): Queryable<TResult> {
    return new InnerJoinQueryable(this, array2, keySelector1, keySelector2, resultSelector);
};
Queryable.prototype.leftJoin = function <T, T2, TKey, TResult>(this: Queryable<T>, array2: Queryable<T2>, keySelector1: (item: T) => TKey, keySelector2: (item: T2) => TKey, resultSelector?: (item1: T, item2: T2 | null) => TResult): Queryable<TResult> {
    return new LeftJoinQueryable(this, array2, keySelector1, keySelector2, resultSelector);
};
Queryable.prototype.rightJoin = function <T, T2, TKey, TResult>(this: Queryable<T>, array2: Queryable<T2>, keySelector1: (item: T) => TKey, keySelector2: (item: T2) => TKey, resultSelector?: (item1: T | null, item2: T2) => TResult): Queryable<TResult> {
    return new RightJoinQueryable(this, array2, keySelector1, keySelector2, resultSelector);
};
Queryable.prototype.fullJoin = function <T, T2, TKey, TResult>(this: Queryable<T>, array2: Queryable<T2>, keySelector1: (item: T) => TKey, keySelector2: (item: T2) => TKey, resultSelector?: (item1: T | null, item2: T2 | null) => TResult): Queryable<TResult> {
