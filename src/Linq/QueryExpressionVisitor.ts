                ...
                case "min":
                    {
                        ...
                        const methodExp = new MethodCallExpression(selectOperand, expression.methodName, [colEntityExp.column], Number);
                        const column = new ComputedColumnExpression(selectOperand.entity, methodExp, this.newAlias("column"));
