...
export function ListRelation<S, T>(option: IRelationMetaData<S, T, keyof S, keyof T>)
    : (target: object, propertyKey: string | symbol, descriptor: PropertyDescriptor) => void;
export function ListRelation<S, T>(masterType: genericType<T>, sourceKeySelectors: Array<(source: S) => any>, targetKeySelectors: Array<(source: T) => any>, backRelation?: (target: T) => S[], updateCascade?: ReferenceOption, deleteCascade?: ReferenceOption)
    : (target: object, propertyKey: string | symbol, descriptor: PropertyDescriptor) => void;
export function ListRelation<S, T>(masterType: genericType<T> | IRelationMetaData<S, T, keyof S, keyof T>, sourceKeySelectors?: Array<(source: S) => any>, targetKeySelectors?: Array<(source: T) => any>, backRelation?: (target: T) => S[], updateCascade?: ReferenceOption, deleteCascade?: ReferenceOption)
    ...
    if (typeof masterType === "object") {
        ...
        return (target: S, propertyKey: string /* | symbol*/, descriptor: PropertyDescriptor) => {
            ...
            if (backRelationName) {
                ...
                if (relationMetaData == null) {
                    relationMetaData = new RelationMetaData(masterType, target.constructor as genericType<S>, [], RelationType.OneToMany);
