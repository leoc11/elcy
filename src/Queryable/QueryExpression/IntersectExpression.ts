...
export class IntersectExpression<T extends object> extends ProjectionEntityExpression<T> {
    constructor(public readonly subSelect: SelectExpression<object, T>, public readonly subSelect2: SelectExpression<object, T>, type?: GenericType<T>) {
