...
export class BitwiseSignedRightShiftAssignmentExpression extends ExpressionBase<number> implements IBinaryOperatorExpression {
    public static create(leftOperand: ParameterExpression<number>, rightOperand: IExpression<number>) {
        return new BitwiseSignedRightShiftAssignmentExpression(leftOperand, rightOperand);
    }
    ...
    public clone() {
        return new BitwiseSignedRightShiftAssignmentExpression(this.leftOperand, this.rightOperand);
    }
}
