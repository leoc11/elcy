...
export class BitwiseZeroRightShiftAssignmentExpression extends ExpressionBase<number> implements IBinaryOperatorExpression {
    public static create(leftOperand: ParameterExpression<number>, rightOperand: IExpression<number>) {
        return new BitwiseZeroRightShiftAssignmentExpression(leftOperand, rightOperand);
    }
    ...
    public clone() {
        return new BitwiseZeroRightShiftAssignmentExpression(this.leftOperand, this.rightOperand);
    }
}
