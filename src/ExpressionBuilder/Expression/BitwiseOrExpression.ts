...
export class BitwiseOrExpression extends BitwiseExpression implements IBinaryOperatorExpression {
    ...
    public clone() {
        return new BitwiseOrExpression(this.leftOperand, this.rightOperand);
    }
}
