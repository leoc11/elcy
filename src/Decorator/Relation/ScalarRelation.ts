...
export function ScalarRelation<S, T>(masterType: genericType<T>, sourceKeySelectors: Array<(source: S) => any>, targetKeySelectors: Array<(source: T) => any>, masterRelationPropertySelector?: (master: T) => S, updateOption?: ReferenceOption, deleteOption?: ReferenceOption)
    : (target: object, propertyKey: string | symbol, descriptor: PropertyDescriptor) => void;
export function ScalarRelation<S, T>(masterType: genericType<T> | IRelationOption<S, T>, sourceKeySelectors?: Array<(source: S) => any>, targetKeySelectors?: Array<(source: T) => any>, masterRelationPropertySelector?: (master: T) => S, updateOption?: ReferenceOption, deleteOption?: ReferenceOption)
