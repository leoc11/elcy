...
export class SumDeferredQuery extends DQLDeferredQuery<number> {
    ...
    protected buildQuery(visitor: IQueryVisitor): QueryExpression<number> {
        ...
        const methodExpression = new MethodCallExpression(commandQuery, "sum", []);
    ...
    protected getQueryCacheKey() {
        return hashCode("SUM", super.getQueryCacheKey());
    }
}
