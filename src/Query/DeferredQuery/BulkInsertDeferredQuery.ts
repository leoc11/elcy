...
import { InsertDeferredQuery } from "./InsertDeferredQuery";

export class BulkInsertDeferredQuery<T = any> extends DeferredQuery<T[]> {
    constructor(
        protected readonly dbContext: DbContext,
        protected readonly defers: Array<InsertDeferredQuery<T>>
    ) {
