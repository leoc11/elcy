...
export class MaxDeferredQuery extends DQLDeferredQuery<number> {
    ...
    protected buildQuery(visitor: IQueryVisitor): QueryExpression<number> {
        ...
        const methodExpression = new MethodCallExpression(commandQuery, "max", []);
    ...
    protected getQueryCacheKey() {
        return hashCode("MAX", super.getQueryCacheKey());
    }
}
