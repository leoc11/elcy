...
export class RightJoinQueryable<T = unknown, T2 = unknown, R = unknown> extends JoinQueryable<T, T2, R> {
    constructor(public readonly parent: Queryable<T>, protected readonly parent2: Queryable<T2>, relation: FunctionExpression<boolean> | ((item: T, item2: T2) => boolean), resultSelector: FunctionExpression<R> | ((item1: T | null, item2: T2) => R), public type: IObjectType<R> | ObjectConstructor = Object) {
