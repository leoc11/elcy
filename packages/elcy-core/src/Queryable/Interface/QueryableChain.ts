...
export type QueryableChain<T> = T extends Queryable<infer U> ? QueryableArrayChain<U> & QueryaChainMarker<T>
    : T extends GroupedEnumerable<infer K, infer U> ? QueryableGroupArrayChain<K, U> & QueryaChainMarker<T>
    : T extends Enumerable<infer U> ? QueryableArrayChain<U> & QueryaChainMarker<T>
    : T extends Array<infer U> ? QueryableArrayChain<U> & QueryaChainMarker<T>
    : T extends MainValueType ? T
    : T extends object ? QueryableObjectChain<T>
    : T;

export type Unchain<T> = T extends QueryaChainMarker<infer U> ? U
...
type QueryableObjectChain<T extends object> = {
    [P in keyof T]-?
    : NonNullable<T[P]> extends GroupedEnumerable<infer K, infer U> ? QueryableGroupArrayChain<K, U> & QueryaChainMarker<T[P]>
    : NonNullable<T[P]> extends Enumerable<infer U> ? QueryableArrayChain<U> & QueryaChainMarker<T[P]>
    : NonNullable<T[P]> extends Array<infer U> ? QueryableArrayChain<U> & QueryaChainMarker<T[P]>
