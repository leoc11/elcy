...
export type ClassPropertyContext<TE = any, T = any> = ClassFieldDecoratorContext<TE, T> | ClassAccessorDecoratorContext<TE, T>;
...
export type ClassGetterDecorator<TE = any, T = any> = (value: Function, context: ClassGetterDecoratorContext<TE, T>) => void;
export type ClassSetterDecorator<TE = any, T = any> = (value: Function, context: ClassSetterDecoratorContext<TE, T>) => void;
