...
export function ModifiedDateColumn<TE extends object, T extends DateTimeValueType>(option?: IDateTimeColumnOption<T>): ClassPropertyDecorator<TE, DateTimeValueType>;
export function ModifiedDateColumn<TE extends object, T extends DateTimeValueType>(name: string, dbtype: DateTimeColumnType, timeZoneHandling?: TimeZoneHandling): ClassPropertyDecorator<TE, DateTimeValueType>;
export function ModifiedDateColumn<TE extends object, T extends DateTimeValueType>(optionOrName?: IDateTimeColumnOption<T> | string, dbtype?: DateTimeColumnType, timeZoneHandling?: TimeZoneHandling): ClassPropertyDecorator<TE, DateTimeValueType> {
