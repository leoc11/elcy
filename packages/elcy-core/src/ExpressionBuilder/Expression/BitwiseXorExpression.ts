...
export class BitwiseXorExpression<T extends number | bigint> extends BitwiseExpression<T> implements IBinaryOperatorExpression<T> {
    ...
    public clone(replaceMap?: Map<IExpression, IExpression>) {
        ...
        const clone = new BitwiseXorExpression<T>(left, right);
