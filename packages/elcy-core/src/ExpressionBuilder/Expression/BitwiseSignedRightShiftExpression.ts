...
export class BitwiseSignedRightShiftExpression<T extends number | bigint> extends BitwiseExpression<T> implements IBinaryOperatorExpression<T> {
    ...
    public clone(replaceMap?: Map<IExpression, IExpression>) {
        ...
        const clone = new BitwiseSignedRightShiftExpression<T>(left, right);
