...
export class BitwiseZeroLeftShiftExpression<T extends number | bigint> extends BitwiseExpression<T> implements IBinaryOperatorExpression<T> {
    ...
    public clone(replaceMap?: Map<IExpression, IExpression>) {
        ...
        const clone = new BitwiseZeroLeftShiftExpression<T>(left, right);
