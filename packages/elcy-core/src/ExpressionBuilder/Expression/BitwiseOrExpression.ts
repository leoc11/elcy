...
export class BitwiseOrExpression<T extends number | bigint> extends BitwiseExpression<T> implements IBinaryOperatorExpression<T> {
    ...
    public clone(replaceMap?: Map<IExpression, IExpression>) {
        ...
        const clone = new BitwiseOrExpression<T>(left, right);
