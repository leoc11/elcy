...
const keyString = (a: unknown): string => {
    ...
    switch (true) {
        case a instanceof Object: {
            return JSON.stringify(Enumerable.from(Object.entries(a))
...
export class GroupByIterator<K, T> implements Iterator<T, unknown, unknown> {
    ...
    constructor(protected readonly source: IterableIterator<T>, protected readonly keySelector: (item: T) => K) { }
