...
describe("QUERYABLE", async () => {
    ...
    describe("SELECT MANY", async () => {
        ...
        it("select many with nested select to entity", async () => {
            ...
            chai.should();
            spy.should.have.been.calledOnce.and.calledWithMatch({
                query: "SELECT [entity2].[ProductId],\n\t[entity2].[Price]\nFROM [Products] AS [entity2]\nLEFT JOIN (\n\tSELECT [entity1].[OrderDetailId],\n\t\t[entity1].[ProductId],\n\t\t[entity1].[OrderId],\n\t\t[entity1].[ProductName],\n\t\t[entity1].[Quantity],\n\t\t[entity1].[CreatedDate],\n\t\t[entity1].[isDeleted]\n\tFROM [OrderDetails] AS [entity1]\n\tINNER JOIN [Orders] AS [entity0]\n\t\tON ([entity1].[OrderId] = [entity0].[OrderId])\n\tWHERE ([entity1].[isDeleted] = 0)\n) AS [entity1]\n\tON ([entity2].[ProductId] = [entity1].[ProductId])",
                type: QueryType.DQL,
                parameters: {}
            } as IQuery);
        ...
        it("should worked in chain", async () => {
            ...
            chai.should();
            spy.should.have.been.calledOnce.and.calledWithMatch({
                query: "SELECT [entity2].[OrderDetailPropertyId],\n\t[entity2].[OrderDetailId],\n\t[entity2].[Name],\n\t[entity2].[Amount]\nFROM [OrderDetailProperties] AS [entity2]\nINNER JOIN (\n\tSELECT [entity1].[OrderDetailId],\n\t\t[entity1].[OrderId],\n\t\t[entity1].[ProductId],\n\t\t[entity1].[ProductName],\n\t\t[entity1].[Quantity],\n\t\t[entity1].[CreatedDate],\n\t\t[entity1].[isDeleted]\n\tFROM [OrderDetails] AS [entity1]\n\tINNER JOIN [Orders] AS [entity0]\n\t\tON ([entity1].[OrderId] = [entity0].[OrderId])\n\tWHERE ([entity1].[isDeleted] = 0)\n) AS [entity1]\n\tON ([entity2].[OrderDetailId] = [entity1].[OrderDetailId])",
                type: QueryType.DQL,
                parameters: {}
            } as IQuery);
    ...
    describe("ANY", async () => {
        it("should work", async () => {
            ...
            chai.should();
            spy.should.have.been.calledOnce.and.calledWithMatch({
                query: "SELECT TOP 1 1 AS [column0]\nFROM [Orders] AS [entity0]",
                type: QueryType.DQL,
                parameters: {}
            } as IQuery);
    ...
    describe("ALL", async () => {
        it("should work", async () => {
            ...
            chai.should();
            spy.should.have.been.calledOnce.and.calledWithMatch({
                query: "SELECT TOP 1 0 AS [column0]\nFROM [Orders] AS [entity0]\nWHERE NOT(\n\t([entity0].[TotalAmount] <= 20000)\n)",
                type: QueryType.DQL,
                parameters: {}
            } as IQuery);
    ...
    describe("MAX", async () => {
        it("should work", async () => {
            ...
            chai.should();
            spy.should.have.been.calledOnce.and.calledWithMatch({
                query: "SELECT MAX([entity0].[TotalAmount]) AS [column0]\nFROM [Orders] AS [entity0]",
                type: QueryType.DQL,
                parameters: {}
            } as IQuery);
    ...
    describe("MIN", async () => {
        it("should work", async () => {
            ...
            chai.should();
            spy.should.have.been.calledOnce.and.calledWithMatch({
                query: "SELECT MIN([entity0].[TotalAmount]) AS [column0]\nFROM [Orders] AS [entity0]",
                type: QueryType.DQL,
                parameters: {}
            } as IQuery);
    ...
    describe("AVG", async () => {
        it("should work", async () => {
            ...
            chai.should();
            spy.should.have.been.calledOnce.and.calledWithMatch({
                query: "SELECT AVG([entity0].[TotalAmount]) AS [column0]\nFROM [Orders] AS [entity0]",
                type: QueryType.DQL,
                parameters: {}
            } as IQuery);
    ...
    describe("SUM", async () => {
        it("should work", async () => {
            ...
            chai.should();
            spy.should.have.been.calledOnce.and.calledWithMatch({
                query: "SELECT SUM([entity0].[TotalAmount]) AS [column0]\nFROM [Orders] AS [entity0]",
                type: QueryType.DQL,
                parameters: {}
            } as IQuery);
    ...
    describe("COUNT", async () => {
        it("should work", async () => {
            ...
            chai.should();
            spy.should.have.been.calledOnce.and.calledWithMatch({
                query: "SELECT COUNT([entity0].[OrderId]) AS [column1]\nFROM [Orders] AS [entity0]\nLEFT JOIN (\n\tSELECT [entity1].[OrderId],\n\t\tSUM([entity1].[Quantity]) AS [column0]\n\tFROM [OrderDetails] AS [entity1]\n\tWHERE ([entity1].[isDeleted] = 0)\n\tGROUP BY [entity1].[OrderId]\n) AS [entity1]\n\tON ([entity0].[OrderId] = [entity1].[OrderId])\nWHERE ([column0] > 3)",
                type: QueryType.DQL,
                parameters: {}
            } as IQuery);
    ...
    describe("TAKE SKIP", async () => {
        it("should work", async () => {
            ...
            chai.should();
            // TODO: should pass empty parameters
            spy.should.have.been.calledOnce.and.calledWithMatch({
                query: "SELECT [entity0].[OrderId],\n\t[entity0].[TotalAmount],\n\t[entity0].[OrderDate]\nFROM [Orders] AS [entity0]\nORDER BY (SELECT NULL)\nOFFSET 5 ROWS\nFETCH NEXT 1 ROWS ONLY",
                type: QueryType.DQL,
                parameters: { param0: 1, param1: 5 }
            } as IQuery);
    ...
    describe("FIRST", async () => {
        ...
        it("should work with select", async () => {
            ...
            chai.should();
            spy.should.have.been.calledOnce.and.calledWithMatch({
                query: "SELECT [entity0].[OrderId]\nFROM [Orders] AS [entity0];\n\nSELECT DISTINCT [entity0].[OrderId],\n\t[entity0].[TotalAmount],\n\t[entity0].[OrderDate]\nFROM [Orders] AS [entity0]\nINNER JOIN [Orders] AS [temp_entity0]\n\tON ([temp_entity0].[OrderId] = [entity0].[OrderId]);\n\nSELECT DISTINCT [entity1].[OrderDetailId],\n\t[entity1].[OrderId],\n\t[entity1].[ProductId],\n\t[entity1].[ProductName],\n\t[entity1].[Quantity],\n\t[entity1].[CreatedDate],\n\t[entity1].[isDeleted]\nFROM [OrderDetails] AS [entity1]\nINNER JOIN (\n\tSELECT [entity2].[OrderDetailId],\n\t\tCOUNT([entity2].[OrderDetailId]) AS [column0]\n\tFROM [OrderDetails] AS [entity2]\n\tINNER JOIN (\n\t\tSELECT [entity3].[OrderDetailId],\n\t\t\t[entity3].[OrderId],\n\t\t\t[entity3].[CreatedDate],\n\t\t\t[entity3].[ProductId],\n\t\t\t[entity3].[ProductName],\n\t\t\t[entity3].[Quantity],\n\t\t\t[entity3].[isDeleted]\n\t\tFROM [OrderDetails] AS [entity3]\n\t\tWHERE ([entity3].[isDeleted] = 0)\n\t) AS [entity3]\n\t\tON (([entity3].[OrderId] = [entity2].[OrderId]) AND (([entity3].[CreatedDate] < [entity2].[CreatedDate]) OR (([entity3].[CreatedDate] = [entity2].[CreatedDate]) AND ([entity3].[OrderDetailId] >= [entity2].[OrderDetailId]))))\n\tWHERE ([entity2].[isDeleted] = 0)\n\tGROUP BY [entity2].[OrderDetailId]\n\tHAVING (COUNT([entity2].[OrderDetailId]) <= 1)\n) AS [entity2]\n\tON ([entity1].[OrderDetailId] = [entity2].[OrderDetailId])\nINNER JOIN [Orders] AS [temp_entity0]\n\tON ([temp_entity0].[OrderId] = [entity1].[OrderId])\nWHERE ([entity1].[isDeleted] = 0)\nORDER BY [entity1].[CreatedDate] DESC",
                type: QueryType.DQL,
                parameters: {}
            } as IQuery);
    ...
    describe("GROUP BY", async () => {
        ...
        it("groupBy.(o => o.column + o.column).select(o => o.key)", async () => {
            ...
            chai.should();
            spy.should.have.been.calledOnce.and.calledWithMatch({
                query: "SELECT (DAY([entity0].[OrderDate]) + YEAR([entity0].[OrderDate])) AS [key]\nFROM [Orders] AS [entity0]\nGROUP BY (DAY([entity0].[OrderDate]) + YEAR([entity0].[OrderDate]))",
                type: QueryType.DQL,
                parameters: {}
            } as IQuery);
    ...
    describe("PARAMETERS", async () => {
        it("should work", async () => {
            ...
            spy.should.have.been.calledOnce.and.calledWithMatch({
                ...
                type: QueryType.DQL,
                parameters: { param0: paramObj.now }
            } as IQuery);
        ...
        it("should be computed in application", async () => {
            ...
            spy.should.have.been.calledOnce.and.calledWithMatch({
                ...
                type: QueryType.DQL,
                parameters: { param0: paramObj.now.getDate() }
            } as IQuery);
